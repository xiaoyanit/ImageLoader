...
public final class ImageTagFactory {
	...
	/**
	 * Use newInstance instead. private
	 * 
	 * @param width
	 * @param height
	 ...
	 * @param defaultImageResId
	 *            resource id of an placeholder image to be used while the original image is loaded or as an error image.
	 * @return
	 */
	 ...
	 * 
	 * @param context
	 *            Context used to access the device display
	 * @param defaultImageResId
	 *            resource id of an placeholder image to be used while the original image is loaded or as an error image.
	 * @return
	 */
	...
	/**
	 * Sets the default image to be used while the original image is loaded. Affects ImageWrapper.loadingResourceId
	 * 
	 * @param defaultImageResId
	 *            resource id of an placeholder image
	 */
	...
	/**
	 * Set the width of the images Affects directly ImageWrapper.width
	 * 
	 * @param width
	...
	/**
	 * Set the height of the images Affects directly ImageWrapper.height
	 * 
	 * @param height
	...
	/**
	 * Sets the error image to be used when an error (e.g. network error) occurred during downloading the image. Affects ImageWrapper.notFoundResourceId
	 * 
	...
	/**
	 * Prepares this factory for using preview images (thumbnails). Affects directly ImageWrapper.previewHeight, ImageWrapper.previewWidth and indirectly
	 * ImageWrapper.previewUrl
	 * 
	 * @param previewImageWidth
	 *            width of the preview image (thumbnail)
	 * @param previewImageHeight
	 *            height of the preview image (thumbnail)
	 * @param useSameUrlForPreviewImage
	 *            if true ImageTags are built with the same url for preview images as for the original images.
	 */
	...
	/**
	 * Sets a flag indicating whether only the cache should be used for image retrieval. Affects directly ImageWrapper.useOnlyCache
	 * 
	 * If true the Loader must not start downloading the image. It depends on the loader what image is shown if the original image was not found in the cache.
	 * 
	 * @param useOnlyCache
	 *            if true only image cache is used.
	 */
	...
	/**
	 * Sets a flag indicating whether scaled images should be stored as file. Affects directly ImageWrapper.saveThumbnail
	 * 
	 ...
	 * 
	 * @param saveThumbnail
	 *            if true the image is scaled and saved
	 */
	 ...
	 * 
	 * @param url
	 *            url of original image to be shown in a ImageView
