...
Image loader is a simple library that helps you fetch, load and cache images in Android apps.
ImageLoader downloads images off the UI thread and caches with a two-level in-memory/SD card cache.
