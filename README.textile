...
Improve cuncurrent loader, change sdcard image position to respect Android SDK guide lines.
...
This work well when you have a list of items with small images chaced and then you go to the details to show a big image. 
...
<pre><code>
//If the small image use as preview is the same
