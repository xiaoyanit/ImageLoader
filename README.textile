...
With Maven: <code>mvn clean install</code>
With Maven, using Eclipse Android projects: <code>mvn clean install -Peclipse</code>
With IntelliJ: Import as a Maven project from the project root.

h4. Demo and acceptance projects

With Eclipse, these should be configured as Android projects.
