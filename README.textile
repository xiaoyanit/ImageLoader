...
https://github.com/novoda/public-mvn-repo/raw/master/releases/com/novoda/imageloader/imageloader-core/1.4.1/imageloader-core-1.4.1.jar
...
thumbnailImageLoader = new SingleThreadedImageLoader(this, settings) {
  @Override
	protected BitmapCache createCache() {
		return new LruBitmapCache(NUMBER_OF_IMAGE_IN_CACHE);
	}
};
</code></pre>
...
SettingsBuilder builder = new SettingsBuilder();
Settings settings = builder.build(this);
//Default value to 15 sec
settings.setConnectionTimeout(20000);
//Default value to 90 sec
settings.setReadTimeout(60000);
</code></pre>
